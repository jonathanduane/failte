...
export default function DABSliderImages() {
  ...
  return (
    <section className="relative h-[70vh] overflow-hidden bg-gradient-to-br from-slate-900 to-slate-800">
      ...
      <Button
        variant="ghost"
        size="icon"
        className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-black/30 hover:bg-black/50 text-white rounded-full backdrop-blur-sm"
        onClick={prevSlide}
      >
      ...
      <Button
        variant="ghost"
        size="icon"
        className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-black/30 hover:bg-black/50 text-white rounded-full backdrop-blur-sm"
        onClick={nextSlide}
      >
